...
class SubeSabitGiderDonemi(BaseModel):
    ...
    periyot_gun_sayisi = db.Column(db.Integer, nullable=False, default=30)
    periyot_tipi = db.Column(db.String(10), nullable=False, default='ay')
    periyot_degeri = db.Column(db.Integer, nullable=False, default=1)
